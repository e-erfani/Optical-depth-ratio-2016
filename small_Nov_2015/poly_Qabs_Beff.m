...
rrr=annotation('textbox', [.5071 .81, .1, .1], 'String', str);
set(rrr,'Fontsize',15)

%set(gca, 'XScale', 'log')
xlabel('\beta_e_f_f (unitless)','fontSize',h_axis+6);
ylabel('Q_a_b_s(12\mum)eff/2 (unitless)','fontSize',h_axis+6);
box on
%ylim([1E5 1E9])
xlim([1 1.6])
